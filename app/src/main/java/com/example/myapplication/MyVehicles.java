...
//
//        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_my_vehicles);
...
public class MyVehicles  {
    ...
    public MyVehicles(String id,String contact, String type, String vehicleNumber) {
        this.id = id;
